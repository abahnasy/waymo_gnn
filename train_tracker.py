    ...
    for epoch in range(cfg.max_epochs):
        for i in range(1, len(train_data_extract)): # TODO: dataloader
            ...
            for idx in range(M): # num of boxes
                ...
                print("++++box data", track_data['boxes3d'][idx])
                print(track_data['box_labels'][idx])
                print(track_data['num_points_in_gt'][idx])
            ...
            for t in range(int(track_data['frame_id'])-1,earliest_frame,-1):
                for idx in range(M):
                    ...
                    if curr_box_id in train_data_extract[t]['boxes_id_map'].keys():
                        ...
                        track_boxes3d[idx, ::counters[idx],:] = train_data_extract[t]['boxes_id_map'][curr_box_id]
                        counters[idx] -= 1
            ...
            model(det_pc_in_box, det_data['boxes3d'], track_pc_in_box, track_boxes3d, graph_adj_matrix)
