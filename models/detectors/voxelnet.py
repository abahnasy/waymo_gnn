...
class VoxelNet(SingleStageDetector):
    ...
    def forward(self, example, return_loss=True, **kwargs):
        ...
        # print("Timer, total Backbone pass {}".format(time.time() -t)); t= time.time()
        preds = self.bbox_head(x)
        # print("Timer, Center head forward {}".format(time.time() -t)); t= time.time()
        if return_loss:
    ...
    def forward_two_stage(self, example, return_loss=True, **kwargs):
        """ used only in case of two stage detector
        """
