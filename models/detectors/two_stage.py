import logging
from models.registry import SECOND_STAGE
import torch
import torch.nn as nn

from models.registry import DETECTORS, ROI_HEAD
...
class TwoStageDetector(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        # check the presence of a pretrained model for the first stage
        assert first_stage_cfg.cfg.pretrained != None
        super(TwoStageDetector, self).__init__()
        self.single_det = build_model(first_stage_cfg, DETECTORS) # build first stage
        ...
        for module in second_stage_modules:
            self.second_stage.append(build_from_cfg_dict(module, SECOND_STAGE))

        self.roi_head = build_from_cfg_dict(roi_head, ROI_HEAD)
